...
- [📖 About the Project](#Musical-Concert-Capstone)
...
# 📖 [Microverse-Portfolio-Project] <a name="Musical-Concert-Capstone"></a>

**[Musical-Concert-Capstone]** is a website that basically advertises a music concert that will take place in future. It provide the required information about the concert, that is brief description, the program plan, the artists to perfom and also the partnering companies for the event.
...
Feel free to check the [issues page](https://github.com/Amen-Musingarimi/musical-concert-capstone/issues).
